...
export function isSpritePixelTransparent(img, spriteRect, px, py) {
 ...
 */
export function remapSpritePalette(img, colorMap) {
...
export function getAnyBlockAtWorld(x, y, SPRITE_SCALE, mapBlocks, doorEntities, buttonEntities, creatureEntities) {
    x = Math.round(x);
    y = Math.round(y);
    // Check map blocks
...
export function getSolidBlockAtWorld(x, y, spriteMap, SPRITE_SCALE, mapBlocks, doorEntities, buttonEntities) {
    x = Math.round(x);
    y = Math.round(y);
    // Check map blocks
    for (const b of mapBlocks) {
...
export function calculateSpriteCollisionBoundingBoxes(spriteSheet, spriteMap, mapBlocks, doorEntities, buttonEntities) {
...
export function calculateAstronautSpriteBoundingBoxes(spriteSheet, spriteMap) {
    return __awaiter(this, void 0, void 0, function* () {
